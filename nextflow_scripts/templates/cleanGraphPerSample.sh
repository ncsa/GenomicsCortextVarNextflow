...
${params.cortexBinCleanGraphPerSample} ${params.cortexConfigCleanGraphPerSample} --multicolour_bin ${params.resultsDir}/poolAndCleanErrorOutput/pooledAndCleanedGraph.ctx --colour_list ${params.resultsDir}/cleanGraphPerSampleFolder/colorlistFileToSubmit${samplePairFileName} --load_colours_only_where_overlap_clean_colour 0 --successively_dump_cleaned_colours cleanedByComparisonToPool > cleanGraphPerSample${samplePairFileName}.log
